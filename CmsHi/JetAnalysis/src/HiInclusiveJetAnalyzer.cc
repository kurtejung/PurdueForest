	...
	geo(0)
{
	...
	doCaloMatch_ = iConfig.getUntrackedParameter<bool>("useMatch","true");
	...
	if(doLifeTimeTagging_){
		ImpactParameterTagInfos_ = iConfig.getUntrackedParameter<string>("ImpactParameterTagInfos","akPu3PFImpactParameterTagInfos");
		TrackCountingHighEffBJetTags_ = iConfig.getUntrackedParameter<string>("TrackCountingHighEffBJetTags","akPu3PFTrackCountingHighEffBJetTags");
		NegativeTrackCountingHighEffJetTags_ = iConfig.getUntrackedParameter<string>("NegativeTrackCountingHighEffJetTags","akPu3PFNegativeTrackCountingHighEffJetTags");
		TrackCountingHighPurBJetTags_ = iConfig.getUntrackedParameter<string>("TrackCountingHighPurBJetTags","akPu3PFTrackCountingHighPurBJetTags");
		NegativeTrackCountingHighPur_ = iConfig.getUntrackedParameter<string>("NegativeTrackCountingHighPur","akPu3PFNegativeTrackCountingHighPur");
		JetProbabilityBJetTags_ = iConfig.getUntrackedParameter<string>("JetProbabilityBJetTags","akPu3PFJetProbabilityBJetTags");
		PositiveOnlyJetProbabilityJetTags_ = iConfig.getUntrackedParameter<string>("PositiveOnlyJetProbabilityJetTags","akPu3PFPositiveOnlyJetProbabilityJetTags");
		NegativeOnlyJetProbabilityJetTags_ = iConfig.getUntrackedParameter<string>("NegativeOnlyJetProbabilityJetTags","akPu3PFNegativeOnlyJetProbabilityJetTags");
		JetBProbabilityBJetTags_ = iConfig.getUntrackedParameter<string>("JetBProbabilityBJetTags","akPu3PFJetBProbabilityBJetTags");
		NegativeOnlyJetBProbabilityJetTags_ = iConfig.getUntrackedParameter<string>("NegativeOnlyJetBProbabilityJetTags","akPu3PFNegativeOnlyJetBProbabilityJetTags");
		PositiveOnlyJetBProbabilityJetTags_ = iConfig.getUntrackedParameter<string>("PositiveOnlyJetBProbabilityJetTags","akPu3PFPositiveOnlyJetBProbabilityJetTags");
		SecondaryVertexTagInfos_ = iConfig.getUntrackedParameter<string>("SecondaryVertexTagInfos","akPu3PFSecondaryVertexTagInfos");
		SecondaryVertexNegativeTagInfos_ = iConfig.getUntrackedParameter<string>("SecondaryVertexNegativeTagInfos","akPu3PFSecondaryVertexNegativeTagInfos");
		SimpleSecondaryVertexHighEffBJetTags_ = iConfig.getUntrackedParameter<string>("SimpleSecondaryVertexHighEffBJetTags","akPu3PFSimpleSecondaryVertexHighEffBJetTags");
		SimpleSecondaryVertexNegativeHighEffBJetTags_ = iConfig.getUntrackedParameter<string>("SimpleSecondaryVertexNegativeHighEffBJetTags","akPu3PFSimpleSecondaryVertexNegativeHighEffBJetTags");
		SimpleSecondaryVertexHighPurBJetTags_ = iConfig.getUntrackedParameter<string>("SimpleSecondaryVertexHighPurBJetTags","akPu3PFSimpleSecondaryVertexHighPurBJetTags");
		SimpleSecondaryVertexNegativeHighPurBJetTags_ = iConfig.getUntrackedParameter<string>("SimpleSecondaryVertexNegativeHighPurBJetTags","akPu3PFSimpleSecondaryVertexNegativeHighPurBJetTags");
		CombinedSecondaryVertexBJetTags_ = iConfig.getUntrackedParameter<string>("CombinedSecondaryVertexBJetTags","akPu3PFCombinedSecondaryVertexBJetTags");
		CombinedSecondaryVertexNegativeBJetTags_ = iConfig.getUntrackedParameter<string>("CombinedSecondaryVertexNegativeBJetTags","akPu3PFCombinedSecondaryVertexNegativeBJetTags");
		CombinedSecondaryVertexPositiveBJetTags_ = iConfig.getUntrackedParameter<string>("CombinedSecondaryVertexPositiveBJetTags","akPu3PFCombinedSecondaryVertexPositiveBJetTags");
		NegativeSoftMuonByPtBJetTags_ = iConfig.getUntrackedParameter<string>("NegativeSoftMuonByPtBJetTags","akPu3PFNegativeSoftMuonByPtBJetTags");
		PositiveSoftMuonByPtBJetTags_ = iConfig.getUntrackedParameter<string>("PositiveSoftMuonByPtBJetTags","akPu3PFPositiveSoftMuonByPtBJetTags");
	}
...
HiInclusiveJetAnalyzer::beginJob() {
  ...
  if (doLifeTimeTagging_) {
    ...
    t->Branch("svtxnormchi2",    jets_.svtxnormchi2,    "svtxnormchi2[nref]/F");
    ...
    if (doLifeTimeTaggingExtras_) {
      ...
      t->Branch("ipDxy",jets_.ipDxy,"ipDxy[nIP]/F");
      t->Branch("ipDz",jets_.ipDz,"ipDz[nIP]/F");
      t->Branch("ipChi2",jets_.ipChi2,"ipChi2[nIP]/F");
      t->Branch("ipNHit",jets_.ipNHit,"ipNHit[nIP]/F");
      t->Branch("ipNHitPixel",jets_.ipNHitPixel,"ipNHitPixel[nIP]/I");
      t->Branch("ipNHitStrip",jets_.ipNHitStrip,"ipNHitStrip[nIP]/I");
      t->Branch("ipIsHitL1",jets_.ipIsHitL1,"ipIsHitL1[nIP]/O");
  ...
  if(useCentrality_){
   ...
   Handle<JetTagCollection> jetTags_softMuneg;
    ...
    if(doLifeTimeTagging_){
     ...
     //iEvent.getByLabel("", tagInfo_softMuon);
   ...
   for(unsigned int j = 0; j < jets->size(); ++j){
	   ...
	   if(doLifeTimeTagging_){
		   ...
		   //cout << "ith_tagged: "<< ith_tagged << endl;
		   if(ith_tagged >= 0){
		   ...
		   if ( jets_.nsvtx[jets_.nref] > 0) {
			...
			jets_.svtxntrk[jets_.nref]  = tagInfoSV.nVertexTracks(0);
			   /*
			      TrackRefVector vertexTracks=tagInfoSV.vertexTracks();
			      for(unsigned it=0;it<tagInfoSV.nVertexTracks(0) ;it++)
			      {
			      cout<< " vertex track pT  "<<vertexTracks[it]->pt()<<endl;
			      }
			    */
   ...
   if(isMC_){
	...
	if(beamParticles.second != 0)jets_.beamId2 = beamParticles.second->pdg_id();
     ...
     cout << "jet pthat: "<< jets_.pthat << endl;
...
int HiInclusiveJetAnalyzer::TaggedJet(Jet calojet, Handle<JetTagCollection > jetTags ) {
  ...
  for (size_t t = 0; t < jetTags->size(); t++) {
    ...
    //string processname = (jetTags).provenance()->processName();                                                                                                           
  }
  return result;
}
