...
akPu4PFpatSequence_withBtagging.remove(ak4clean)
akPu4PFpatSequence_withBtagging.remove(akPu4PFmatch)
akPu4PFpatSequence_withBtagging.remove(akPu4PFparton)
akPu4PFpatSequence_withBtagging.remove(akPu4PFPatJetFlavourId)
...
ak4PFpatSequence_withBtagging.remove(ak4clean)
ak4PFpatSequence_withBtagging.remove(ak4PFmatch)
ak4PFpatSequence_withBtagging.remove(ak4PFparton)
ak4PFpatSequence_withBtagging.remove(ak4PFPatJetFlavourId)
...
akPu3CalopatSequence_withBtagging.remove(ak3clean)
akPu3CalopatSequence_withBtagging.remove(akPu3Calomatch)
akPu3CalopatSequence_withBtagging.remove(akPu3Caloparton)
akPu3CalopatSequence_withBtagging.remove(akPu3CaloPatJetFlavourId)

akPu4CalopatSequence_withBtagging.remove(ak4clean)
akPu4CalopatSequence_withBtagging.remove(akPu4Calomatch)
akPu4CalopatSequence_withBtagging.remove(akPu4Caloparton)
akPu4CalopatSequence_withBtagging.remove(akPu4CaloPatJetFlavourId)

akPu5CalopatSequence_withBtagging.remove(ak5clean)
akPu5CalopatSequence_withBtagging.remove(akPu5Calomatch)
akPu5CalopatSequence_withBtagging.remove(akPu5Caloparton)
akPu5CalopatSequence_withBtagging.remove(akPu5CaloPatJetFlavourId)

ak3CalopatSequence_withBtagging.remove(ak3clean)
ak3CalopatSequence_withBtagging.remove(ak3Calomatch)
ak3CalopatSequence_withBtagging.remove(ak3Caloparton)
ak3CalopatSequence_withBtagging.remove(ak3CaloPatJetFlavourId)

ak4CalopatSequence_withBtagging.remove(ak4clean)
ak4CalopatSequence_withBtagging.remove(ak4Calomatch)
ak4CalopatSequence_withBtagging.remove(ak4Caloparton)
ak4CalopatSequence_withBtagging.remove(ak4CaloPatJetFlavourId)

ak5CalopatSequence_withBtagging.remove(ak5clean)
ak5CalopatSequence_withBtagging.remove(ak5Calomatch)
ak5CalopatSequence_withBtagging.remove(ak5Caloparton)
ak5CalopatSequence_withBtagging.remove(ak5CaloPatJetFlavourId)
