...
ak1PFJets1 = ak1PFJets0.clone(rParam = cms.double(0.1),puWidth = 1)
ak2PFJets1 = ak1PFJets0.clone(rParam = cms.double(0.2),puWidth = 1)
ak3PFJets1 = ak1PFJets0.clone(rParam = cms.double(0.3),puWidth = 1)
ak4PFJets1 = ak1PFJets0.clone(rParam = cms.double(0.4),puWidth = 1)
ak5PFJets1 = ak1PFJets0.clone(rParam = cms.double(0.5),puWidth = 1)
ak6PFJets1 = ak1PFJets0.clone(rParam = cms.double(0.6),puWidth = 1)
...
recoAk2to5 = cms.Sequence( akPu3PFJets * akPu4PFJets * akPu5PFJets *
                           ak3PFJets * ak4PFJets * ak5PFJets *
                           akPu3CaloJets * akPu4CaloJets * akPu5CaloJets *
                           ak3CaloJets * ak4CaloJets * ak5CaloJets
                           )

recoAk2to5ID = cms.Sequence(
    akPu3PFJetID * akPu4PFJetID * akPu5PFJetID *
                           ak3PFJetID * ak4PFJetID * ak5PFJetID *
                           akPu3CaloJetID * akPu4CaloJetID * akPu5CaloJetID *
                           ak3CaloJetID * ak4CaloJetID * ak5CaloJetID
                           )
#prevent bloating - reduce number of jet collections
recoFastJets = cms.Sequence(ak3PFJets05+ak3PFJets1+ak3PFJets2+ak4PFJets05+ak4PFJets1+ak4PFJets2+ak5PFJets05+ak5PFJets1+ak5PFJets2)
recoBTag = cms.Sequence(akPu3PFJets * akPu4PFJets * akPu5PFJets * akPu3CaloJets * akPu4CaloJets * akPu5CaloJets * ak3PFJets * ak4PFJets * ak5PFJets * ak3CaloJets * ak4CaloJets * ak5CaloJets)
recoBTagID = cms.Sequence(ak3CaloJetID * ak4CaloJetID * ak5CaloJetID * akPu3CaloJetID * akPu4CaloJetID * akPu5CaloJetID)
